...
class AbilitiesControllerTest < ActionController::TestCase
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post :create, ability: { character_id: @ability.character_id, description: @ability.description, name: @ability.name }
    end
  ...
  test "should update ability" do
    patch :update, id: @ability, ability: { character_id: @ability.character_id, description: @ability.description, name: @ability.name }
    assert_redirected_to ability_path(assigns(:ability))
  end
