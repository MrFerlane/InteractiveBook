...
class ConditionsControllerTest < ActionController::TestCase
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post :create, condition: { act_id: @condition.act_id, condition_class: @condition.condition_class, source_class: @condition.source_class, source_name: @condition.source_name, value: @condition.value }
    end
  ...
  test "should update condition" do
    patch :update, id: @condition, condition: { act_id: @condition.act_id, condition_class: @condition.condition_class, source_class: @condition.source_class, source_name: @condition.source_name, value: @condition.value }
    assert_redirected_to condition_path(assigns(:condition))
  end
