...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { character_id: @attribute.character_id, count: @attribute.count, description: @attribute.description, name: @attribute.name }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { character_id: @attribute.character_id, count: @attribute.count, description: @attribute.description, name: @attribute.name }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
